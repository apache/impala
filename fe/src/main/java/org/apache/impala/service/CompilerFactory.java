...
public interface CompilerFactory {
  ...
  /**
   * Create an analysis driver handling the implementation specific parts of analysis.
   */
  ...
  /**
   * Create a single node planner handling the implementation specific parts of the
