...
public class IcebergMergeNode extends PlanNode {
  ...
  private List<Expr> rowMetaExprs_;
  ...
  public IcebergMergeNode(PlanNodeId id, PlanNode child, List<MergeCase> cases,
      Expr rowPresent, List<Expr> rowMetaExprs, List<Expr> partitionMetaExprs,
      TupleDescriptor mergeActionTuple, TupleId targetTupleId) {
    super(id, "MERGE");
    this.cases_ = cases;
    this.rowPresent_ = rowPresent;
    this.rowMetaExprs_ = rowMetaExprs;
  ...
  protected void toThrift(TPlanNode msg) {
    ...
    TIcebergMergeNode mergeNode = new TIcebergMergeNode(mergeCases,
        rowPresent_.treeToThrift(), Expr.treesToThrift(rowMetaExprs_),
  ...
  public void init(Analyzer analyzer) throws ImpalaException {
    ...
    rowMetaExprs_ =
        Expr.substituteList(rowMetaExprs_, getOutputSmap(), analyzer, true);
