...
public class Column {
  ...
  /**
   * Returns true if this column is hidden. Hidden columns are stored in data file,
   * this is how they differ from virtual columns. Hidden columns are not expanded
   * by select *, and are not writable by users. If written, their values are
   * automatically generated by the system. For example, for Iceberg tables, hidden
