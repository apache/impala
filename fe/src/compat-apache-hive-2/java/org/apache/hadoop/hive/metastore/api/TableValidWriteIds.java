...
// Original Source:
// https://github.com/apache/hive/blob/branch-3.1/standalone-metastore/src/gen/thrift/
//       gen-javabean/org/apache/hadoop/hive/metastore/api/TableValidWriteIds.java
...
public class TableValidWriteIds
    implements org.apache.thrift.TBase<TableValidWriteIds, TableValidWriteIds._Fields>,
    java.io.Serializable, Cloneable, Comparable<TableValidWriteIds> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
      new org.apache.thrift.protocol.TStruct("TableValidWriteIds");

  private static final org.apache.thrift.protocol.TField FULL_TABLE_NAME_FIELD_DESC =
      new org.apache.thrift.protocol.TField("fullTableName",
          org.apache.thrift.protocol.TType.STRING, (short)1);
  private static final org.apache.thrift.protocol
      .TField WRITE_ID_HIGH_WATER_MARK_FIELD_DESC =
      new org.apache.thrift.protocol.TField("writeIdHighWaterMark",
          org.apache.thrift.protocol.TType.I64, (short)2);
  private static final org.apache.thrift.protocol.TField INVALID_WRITE_IDS_FIELD_DESC =
      new org.apache.thrift.protocol.TField("invalidWriteIds",
      org.apache.thrift.protocol.TType.LIST, (short)3);
  private static final org.apache.thrift.protocol.TField MIN_OPEN_WRITE_ID_FIELD_DESC =
      new org.apache.thrift.protocol.TField("minOpenWriteId",
          org.apache.thrift.protocol.TType.I64, (short)4);
  private static final org.apache.thrift.protocol.TField ABORTED_BITS_FIELD_DESC =
      new org.apache.thrift.protocol.TField("abortedBits",
  ...
  static {
    ...
    tmpMap.put(_Fields.FULL_TABLE_NAME,
        new org.apache.thrift.meta_data.FieldMetaData("fullTableName",
            org.apache.thrift.TFieldRequirementType.REQUIRED,
        new org.apache.thrift.meta_data.FieldValueMetaData(
            org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.WRITE_ID_HIGH_WATER_MARK,
        new org.apache.thrift.meta_data.FieldMetaData("writeIdHighWaterMark",
            org.apache.thrift.TFieldRequirementType.REQUIRED,
        new org.apache.thrift.meta_data.FieldValueMetaData(
            org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.INVALID_WRITE_IDS,
        new org.apache.thrift.meta_data.FieldMetaData("invalidWriteIds",
            org.apache.thrift.TFieldRequirementType.REQUIRED,
        new org.apache.thrift.meta_data.ListMetaData(
            org.apache.thrift.protocol.TType.LIST,
            new org.apache.thrift.meta_data.FieldValueMetaData(
                org.apache.thrift.protocol.TType.I64))));
    tmpMap.put(_Fields.MIN_OPEN_WRITE_ID,
        new org.apache.thrift.meta_data.FieldMetaData("minOpenWriteId",
            org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.FieldValueMetaData(
            org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.ABORTED_BITS, new org.apache.thrift.meta_data.FieldMetaData(
    "abortedBits", org.apache.thrift.TFieldRequirementType.REQUIRED,
    new org.apache.thrift.meta_data.FieldValueMetaData(
            org.apache.thrift.protocol.TType.STRING        , true)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
        TableValidWriteIds.class, metaDataMap);
  }
  ...
  /** Returns true if field writeIdHighWaterMark is set (has been assigned a value)
   * and false otherwise */
  ...
  /** Returns true if field invalidWriteIds is set (has been assigned a value) and
   * false otherwise */
  ...
  /** Returns true if field minOpenWriteId is set (has been assigned a value) and false
   * otherwise */
  ...
  public void setMinOpenWriteIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __MINOPENWRITEID_ISSET_ID,
        value);
  }
  ...
  public ByteBuffer bufferForAbortedBits() {
    return org.apache.thrift.TBaseHelper
        .copyBinary(abortedBits);
  }

  public void setAbortedBits(byte[] abortedBits) {
    this.abortedBits = abortedBits == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays
        .copyOf(abortedBits, abortedBits.length));
  }
  ...
  /** Returns true if field abortedBits is set (has been assigned a value) and false
   * otherwise */
  ...
  public int compareTo(TableValidWriteIds other) {
    ...
    lastComparison = Boolean.valueOf(isSetFullTableName()).compareTo(
        other.isSetFullTableName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFullTableName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.fullTableName,
          other.fullTableName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetWriteIdHighWaterMark()).compareTo(
        other.isSetWriteIdHighWaterMark());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetInvalidWriteIds()).compareTo(
        other.isSetInvalidWriteIds());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetMinOpenWriteId()).compareTo(
        other.isSetMinOpenWriteId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMinOpenWriteId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.minOpenWriteId,
          other.minOpenWriteId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAbortedBits()).compareTo(
        other.isSetAbortedBits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAbortedBits()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.abortedBits,
          other.abortedBits);
      if (lastComparison != 0) {
        return lastComparison;
      }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetFullTableName()) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'fullTableName' is unset! Struct:" + toString());
    }

    if (!isSetWriteIdHighWaterMark()) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'writeIdHighWaterMark' is unset! Struct:" + toString());
    }

    if (!isSetInvalidWriteIds()) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'invalidWriteIds' is unset! Struct:" + toString());
    }

    if (!isSetAbortedBits()) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'abortedBits' is unset! Struct:" + toString());
    }
  ...
  private static class TableValidWriteIdsTupleScheme
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot,
      ...
      struct.setWriteIdHighWaterMarkIsSet(true);
      {
        org.apache.thrift.protocol.TList _list615 =
