 ...
 */
 ...
 // This code is copied from apache/hive and only some modifications were
 // made to the code format to pass the code check.
 // Original Source:
 // https://github.com/apache/hive/blob/branch-3.1/storage-api/src/java/
 //       org/apache/hadoop/hive/common/ValidReaderWriteIdList.java
...
public class ValidReaderWriteIdList implements ValidWriteIdList {
  ...
  protected BitSet abortedBits; // BitSet for flagging aborted write ids. Bit is true if
  // aborted, false if open
  ...
  public ValidReaderWriteIdList() {
    this(null, new long[0], new BitSet(),
   ...
   */
  public ValidReaderWriteIdList(String tableName, long[] exceptions, BitSet abortedBits,
                                long highWatermark) {
    this(tableName, exceptions, abortedBits, highWatermark, Long.MAX_VALUE);
  }
  public ValidReaderWriteIdList(String tableName,
                                long[] exceptions, BitSet abortedBits, long highWatermark,
                                long minOpenWriteId) {
  ...
  public Long getMinOpenWriteId() {
    return minOpenWriteId == Long.MAX_VALUE ?
        null : minOpenWriteId;
  }
  ...
  public ValidReaderWriteIdList updateHighWatermark(long value) {
    return new ValidReaderWriteIdList(tableName, exceptions, abortedBits, value,
        minOpenWriteId);
  }
}
