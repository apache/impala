...
//       org/apache/hadoop/hive/common/ValidTxnWriteIdList.java
...
/**
 * An implementation to store and manage list of ValidWriteIds for each tables read by
 * current transaction.
 */
public class ValidTxnWriteIdList {
  ...
  // Format <txnId>$<table_name>:<hwm>:<minOpenWriteId>:<open_writeids>
  // :<abort_writeids>$<table_name>...
