...
export APACHE_HBASE_VERSION=2.4.14
export APACHE_ICEBERG_VERSION=0.14.0
export APACHE_KNOX_VERSION=1.6.1
export APACHE_OZONE_VERSION=1.2.1
export APACHE_PARQUET_VERSION=1.12.3
export APACHE_RANGER_VERSION=2.3.0
...
if ${USE_APACHE:=false}; then
  ...
  export IMPALA_RANGER_VERSION=${APACHE_RANGER_VERSION}
...
if $USE_APACHE_RANGER; then
  ...
  export RANGER_HOME="${APACHE_COMPONENTS_HOME}/ranger-${IMPALA_RANGER_VERSION}-admin"
fi
