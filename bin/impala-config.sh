...
export IMPALA_GPERFTOOLS_VERSION=2.10-p2
...
export IMPALA_SIMDUTF_VERSION=9.0.0
unset IMPALA_SIMDUTF_URL
...
export CDP_BUILD_NUMBER=81722820
export CDP_MAVEN_REPOSITORY=\
"https://${IMPALA_TOOLCHAIN_HOST}/build/cdp_components/${CDP_BUILD_NUMBER}/maven"
export CDP_AVRO_JAVA_VERSION=1.11.3.7.3.2.20000-221
export CDP_HADOOP_VERSION=3.4.2.7.3.2.20000-221
export CDP_HBASE_VERSION=2.6.3.7.3.2.20000-221
export CDP_HIVE_VERSION=3.1.3000.7.3.2.20000-221
export CDP_ICEBERG_VERSION=1.10.1.7.3.2.20000-221
export CDP_KNOX_VERSION=2.1.0.7.3.2.20000-221
export CDP_ORC_JAVA_VERSION=2.0.3.7.3.2.20000-221
export CDP_OZONE_VERSION=2.2.0.7.3.2.20000-221
export CDP_PARQUET_VERSION=1.16.0.7.3.2.20000-221
export CDP_RANGER_VERSION=2.8.0.7.3.2.20000-221
export CDP_TEZ_VERSION=0.9.1.7.3.2.20000-221
...
export IMPALA_BOUNCY_CASTLE_VERSION=1.86
...
export IMPALA_HTTPCLIENT5_VERSION=5.5
...
export IMPALA_LOG4J2_VERSION=2.26.1
export IMPALA_PAC4J_VERSION=4.5.10
export IMPALA_RELOAD4j_VERSION=1.2.26
export IMPALA_SLF4J_VERSION=2.0.19
export IMPALA_SPRINGFRAMEWORK_VERSION=5.3.39
export IMPALA_XMLSEC_VERSION=2.3.5
export IMPALA_VELOCITY_ENGINE_CORE_VERSION=2.4.1
export IMPALA_OBS_VERSION=3.1.1-hw-42
export IMPALA_DBCP2_VERSION=2.14.0
export IMPALA_DROPWIZARD_METRICS_VERSION=4.2.40
...
if $USE_APACHE_HIVE_3 || $USE_APACHE_HIVE_2; then
  ...
  export IMPALA_THRIFT_POM_VERSION=0.24.0
...
# for its faster performance and better concurrency control via MOLD_JOBS.
# Note: This is validated in the CMake code.
export IMPALA_LINKER=${IMPALA_LINKER-mold}
