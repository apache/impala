...
export IMPALA_VERSION=4.4.0.3.3.6.0.1
...
# Adding ODP support
export ODP_AVRO_JAVA_VERSION=1.11.3
export ODP_BUILD_NUMBER=3.3.6.0-1
export ODP_HADOOP_VERSION=3.3.6.3.3.6.0-1
export ODP_HBASE_VERSION=2.5.8.3.3.6.0-1
export ODP_HIVE_VERSION=4.0.0.3.3.6.0-1
export ODP_KNOX_VERSION=2.0.0.3.3.6.0-1
export ODP_OZONE_VERSION=1.4.0.3.3.6.0-1
export ODP_PARQUET_VERSION=1.13.1
export ODP_RANGER_VERSION=2.5.0.3.3.6.0-1
export ODP_TEZ_VERSION=0.10.3.3.3.6.0-1
...
export ODP_COMPONENTS_HOME="$IMPALA_TOOLCHAIN/odp_components"
export IMPALA_AVRO_JAVA_VERSION=${ODP_AVRO_JAVA_VERSION:-"$CDP_AVRO_JAVA_VERSION"}
export IMPALA_HADOOP_VERSION=${ODP_HADOOP_VERSION}
export IMPALA_HADOOP_URL=${CDP_HADOOP_URL-}
export HADOOP_HOME="$ODP_COMPONENTS_HOME/hadoop-${IMPALA_HADOOP_VERSION}/"
export IMPALA_HBASE_VERSION=${ODP_HBASE_VERSION}
...
export IMPALA_KNOX_VERSION=${ODP_KNOX_VERSION}
export IMPALA_PARQUET_VERSION=${CDP_PARQUET_VERSION}
export IMPALA_RANGER_VERSION=${RANGER_VERSION_OVERRIDE:-"$ODP_RANGER_VERSION"}
export IMPALA_RANGER_URL=${CDP_RANGER_URL-}
export IMPALA_TEZ_VERSION=${ODP_TEZ_VERSION}
...
if $USE_APACHE_HIVE; then
  ...
  export IMPALA_HIVE_VERSION=${HIVE_VERSION_OVERRIDE:-"$ODP_HIVE_VERSION"}
