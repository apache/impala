...
DEFAULT_REVIEW_SERVER = "172.29.5.196:31111"
...
group.add_option("-r", "--reviewers", action="store", dest="reviewers",
                 metavar="REVIEWERS", default="impala-team",
...
# Git-specific
group.add_option("-b", "--base", action="store", dest="base_for_diff",
                default="HEAD", help="Base for diff (e.g. upstream/master")
# Perforce-specific
...
class GitVCS(VersionControlSystem):
  ...
  def GenerateDiff(self, extra_args):
    ...
    return RunShell(["git", "diff", self.options.base_for_diff, "--no-ext-diff", "--full-index",
