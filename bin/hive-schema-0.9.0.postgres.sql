-- TODO: This file taken from Apache Hive trunk at 
-- https://raw.github.com/apache/hive/trunk/metastore/scripts/upgrade/postgres/hive-schema-0.9.0.postgres.sql
-- When we move to a Hive release (0.10?) with this script included, remove this
-- file in favour of the Hive-provided one.
