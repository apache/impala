...
public class ImpalaRelMdExpressionLineage
    implements MetadataHandler<BuiltInMetadata.ExpressionLineage> {
  public static final RelMetadataProvider SOURCE =
      ReflectiveRelMetadataProvider.reflectiveSource(new ImpalaRelMdExpressionLineage(),
          BuiltInMetadata.ExpressionLineage.Handler.class);

  public Set<RexNode> getExpressionLineage(
      ImpalaCTEConsumer r, RelMetadataQuery mq, RexNode expression) {
    return mq.getExpressionLineage(r.getCTE(), expression);
  }
