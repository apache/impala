...
public class ImpalaRelMdAllPredicates
    implements MetadataHandler<BuiltInMetadata.AllPredicates> {
  public static final RelMetadataProvider SOURCE =
      ReflectiveRelMetadataProvider.reflectiveSource(
          new ImpalaRelMdAllPredicates(), BuiltInMetadata.AllPredicates.Handler.class);

  public RelOptPredicateList getAllPredicates(ImpalaCTEConsumer r, RelMetadataQuery mq) {
    return mq.getAllPredicates(r.getCTE());
  }
