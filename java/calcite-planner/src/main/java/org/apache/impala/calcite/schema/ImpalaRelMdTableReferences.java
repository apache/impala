...
public class ImpalaRelMdTableReferences
    implements MetadataHandler<BuiltInMetadata.TableReferences> {
  public static final RelMetadataProvider SOURCE =
      ReflectiveRelMetadataProvider.reflectiveSource(new ImpalaRelMdTableReferences(),
          BuiltInMetadata.TableReferences.Handler.class);

  public Set<RexTableInputRef.RelTableRef> getTableReferences(
      ImpalaCTEConsumer rel, RelMetadataQuery mq) {
    return mq.getTableReferences(rel.getCTE());
  }
