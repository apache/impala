 ...
 */
public class ImpalaAdjustPrecisionFunction extends SqlFunction {

  public ImpalaAdjustPrecisionFunction(String name) {
  ...
  public RelDataType inferReturnType(SqlOperatorBinding opBinding) {
    ...
    Preconditions.checkState(decimalType.isDecimal());

    int precision =
        Math.min(decimalType.decimalPrecision() + 1, ScalarType.MAX_PRECISION);
    Integer scale = 0;
