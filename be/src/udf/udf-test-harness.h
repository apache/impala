...
class UdfTestHarness {
 public:
  ...
  template<typename RET, typename A1>
  static bool ValidateUdf(boost::function<RET(UdfContext*, int, const A1*)> fn,
  ...
  template<typename RET, typename A1, typename A2>
  static bool ValidateUdf(
      boost::function<RET(UdfContext*, const A1&, int, const A2*)> fn,
  ...
  template<typename RET, typename A1, typename A2, typename A3>
  static bool ValidateUdf(
      boost::function<RET(UdfContext*, const A1&, const A2&, int, const A3*)> fn,
