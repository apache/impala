...
ir_functions = [
  ...
  ["GROUPING_AGG_COPY_GROUPING_VALUES_FIXED_LEN_SLOT",
   "_ZN6impala18GroupingAggregator30CopyGroupingValuesFixedLenSlotEPNS_5TupleEiNS_19NullIndicatorOffsetEii"],
  ["GROUPING_AGG_COPY_GROUPING_VALUES_STRING_SLOT",
