...
class TestPivotClause(ImpalaTestSuite):
  @classmethod
  ...
  def test_pivot_clause(self, unique_database, vector):
    self.run_test_case('QueryTest/pivot-clause', vector, unique_database)
