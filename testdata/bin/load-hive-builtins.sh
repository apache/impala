...
${HADOOP_HOME}/bin/hadoop fs -rm -r -f ${FILESYSTEM_PREFIX}${IMPALA_HOME_HOME}/fe/target/
${HADOOP_HOME}/bin/hadoop fs -mkdir -p ${FILESYSTEM_PREFIX}${IMPALA_HOME_HOME}/fe/target/
...
${HADOOP_HOME}/bin/hadoop fs -put ${IMPALA_HOME}/fe/target/impala-frontend*.jar \
    ${FILESYSTEM_PREFIX}${IMPALA_HOME_HOME}/fe/target/
