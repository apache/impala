...
visible_functions = [
  ...
  [['bytes'], 'INT', ['BINARY'], 'impala::StringFunctions::Bytes'],
  [['bytes'], 'INT', ['GEOMETRY'], 'impala::StringFunctions::Bytes'],
...
# Netezza compatibility char functions
  ...
  [['if'], 'GEOMETRY', ['BOOLEAN', 'GEOMETRY', 'GEOMETRY'], ''],
  ...
  [['isnull', 'ifnull', 'nvl'], 'GEOMETRY', ['GEOMETRY', 'GEOMETRY'], ''],
  ...
  [['ds_hll_union_f'], 'BINARY', ['BINARY', 'BINARY'],
  ...
  [['ds_cpc_union_f'], 'BINARY', ['BINARY', 'BINARY'],
