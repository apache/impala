...
# Conditional Functions
  ...
  ['Conditional_NullIf', 'BOOLEAN', ['BOOLEAN', 'BOOLEAN'],
        'ConditionalFunctions::NullIf<bool>', ['nullif']],
  ['Conditional_NullIf', 'TINYINT', ['TINYINT', 'TINYINT'],
        'ConditionalFunctions::NullIf<int8_t>', ['nullif']],
  ['Conditional_NullIf', 'SMALLINT', ['SMALLINT', 'SMALLINT'],
        'ConditionalFunctions::NullIf<int16_t>', ['nullif']],
  ['Conditional_NullIf', 'INT', ['INT', 'INT'],
        'ConditionalFunctions::NullIf<int32_t>', ['nullif']],
  ['Conditional_NullIf', 'BIGINT', ['BIGINT', 'BIGINT'],
        'ConditionalFunctions::NullIf<int64_t>', ['nullif']],
  ['Conditional_NullIf', 'FLOAT', ['FLOAT', 'FLOAT'],
        'ConditionalFunctions::NullIf<float>', ['nullif']],
  ['Conditional_NullIf', 'DOUBLE', ['DOUBLE', 'DOUBLE'],
        'ConditionalFunctions::NullIf<double>', ['nullif']],
  ['Conditional_NullIf', 'STRING', ['STRING', 'STRING'],
        'ConditionalFunctions::NullIf<StringValue>', ['nullif']],
  ['Conditional_NullIf', 'TIMESTAMP', ['TIMESTAMP', 'TIMESTAMP'],
        'ConditionalFunctions::NullIf<TimestampValue>', ['nullif']],
